...
public class VeggieTest {
    ...
    public static void main(String[] args) {
        // для считывания с консоли (System.in)
        ...
        int itemsLength = TomatoForm.values().length;
        questions[0] = new TomatoForm[itemsLength];
        for (int i = 0; i < itemsLength; i++) {
            questions[0][i] = TomatoForm.values()[i];
        }

        itemsLength = CucumberColor.values().length;
        questions[1] = new CucumberColor[itemsLength];
        for (int i = 0; i < itemsLength; i++) {
            questions[1][i] = CucumberColor.values()[i];
        }

        itemsLength = SmeltSmell.values().length;
        questions[2] = new SmeltSmell[itemsLength];
        for (int i = 0; i < itemsLength; i++) {
            questions[2][i] = SmeltSmell.values()[i];
        }
